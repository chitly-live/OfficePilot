...
/**
 * `error.tsx` for `/settings` — graceful fallback when the server
 * page throws (Prisma down while loading the `Setting` rows, etc.).
 *
    ...
    <div className="flex flex-col items-center justify-center gap-4 rounded-lg border border-dashed bg-muted/20 px-6 py-16 text-center">
      ...
      <div className="space-y-1">
        ...
        <p className="max-w-sm text-sm text-muted-foreground">
          Something went wrong while fetching your settings. Try
