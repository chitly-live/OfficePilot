...
- **Vitest** + **Playwright** for testing (326 unit + 342 integration + 16 E2E)
...
├── tests/
│   ├── integration/        # 27 files, 342 tests (real Postgres)
...
| Integration | `npm run test:int` | 342 tests, 27 files | Every API route against real Postgres — auth gates, validation, persistence, audit log |
