...
- **Vitest** + **Playwright** for testing (332 unit + 349 integration + 16 E2E)
...
├── tests/
│   ├── integration/        # 28 files, 349 tests (real Postgres)
...
| Integration | `npm run test:int` | 349 tests, 28 files | Every API route against real Postgres — auth gates, validation, persistence, audit log |
