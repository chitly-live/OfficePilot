...
- **Vitest** + **Playwright** for testing (332 unit + 348 integration + 16 E2E)
...
├── tests/
│   ├── integration/        # 28 files, 348 tests (real Postgres)
...
| Integration | `npm run test:int` | 348 tests, 28 files | Every API route against real Postgres — auth gates, validation, persistence, audit log |
